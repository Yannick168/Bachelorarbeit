...
c3=c003*d3**3 + c012*d2*d3**2 + c021*d2**2*d3 + c030*d2**3 + c102*d1*d3**2 + c111*d1*d2*d3 + c120*d1*d2**2 + c201*d1**2*d3 + c210*d1**2*d2 + c300*d1**3
c2=a1*c102*d3**2 + a1*c111*d2*d3 + a1*c120*d2**2 + 2*a1*c201*d1*d3 + 2*a1*c210*d1*d2 + 3*a1*c300*d1**2 + a2*c012*d3**2 + 2*a2*c021*d2*d3 + 3*a2*c030*d2**2 + a2*c111*d1*d3 + 2*a2*c120*d1*d2 + a2*c210*d1**2 + 3*a3*c003*d3**2 + 2*a3*c012*d2*d3 + a3*c021*d2**2 + 2*a3*c102*d1*d3 + a3*c111*d1*d2 + a3*c201*d1**2 + c002*d3**2 + c011*d2*d3 + c020*d2**2 + c101*d1*d3 + c110*d1*d2 + c200*d1**2
c1= a1**2*c201*d3 + a1**2*c210*d2 + 3*a1**2*c300*d1 + a1*a2*c111*d3 + 2*a1*a2*c120*d2 + 2*a1*a2*c210*d1 + 2*a1*a3*c102*d3 + a1*a3*c111*d2 + 2*a1*a3*c201*d1 + a1*c101*d3 + a1*c110*d2 + 2*a1*c200*d1 + a2**2*c021*d3 + 3*a2**2*c030*d2 + a2**2*c120*d1 + 2*a2*a3*c012*d3 + 2*a2*a3*c021*d2 + a2*a3*c111*d1 + a2*c011*d3 + 2*a2*c020*d2 + a2*c110*d1 + 3*a3**2*c003*d3 + a3**2*c012*d2 + a3**2*c102*d1 + 2*a3*c002*d3 + a3*c011*d2 + a3*c101*d1 + c001*d3 + c010*d2 + c100*d1
c0= a1**3*c300 + a1**2*a2*c210 + a1**2*a3*c201 + a1**2*c200 + a1*a2**2*c120 + a1*a2*a3*c111 + a1*a2*c110 + a1*a3**2*c102 + a1*a3*c101 + a1*c100 + a2**3*c030 + a2**2*a3*c021 + a2**2*c020 + a2*a3**2*c012 + a2*a3*c011 + a2*c010 + a3**3*c003 + a3**2*c002 + a3*c001 + c000
...
*/
  ...
  const c3 = c[2]*d3**3 + c[7]*d2*d3**2 + c[6]*d2**2*d3 + c[1]*d2**3 + c[9]*d1*d3**2 + c[3]*d1*d2*d3 + c[8]*d1*d2**2 + 
  c[5]*d1**2*d3 + c[4]*d1**2*d2 + c[0]*d1**3;

  const c2 = a1*c[9]*d3**2 + a1*c[3]*d2*d3 + a1*c[8]*d2**2 + 2*a1*c[5]*d1*d3 + 2*a1*c[4]*d1*d2 + 3*a1*c[0]*d1**2 + a2*c[7]*d3**2 + 2*a2*c[6]*d2*d3 + 3*a2*c[1]*d2**2 + a2*c[3]*d1*d3 + 
  2*a2*c[8]*d1*d2 + a2*c[4]*d1**2 + 3*a3*c[2]*d3**2 + 2*a3*c[7]*d2*d3 + a3*c[6]*d2**2 + 2*a3*c[9]*d1*d3 + a3*c[3]*d1*d2 + a3*c[5]*d1**2 + c[12]*d3**2 + c[15]*d2*d3 + c[11]*d2**2 + 
  c[14]*d1*d3 + c[13]*d1*d2 + c[10]*d1**2;

  const c1 = a1**2*c[5]*d3 + a1**2*c[4]*d2 + 3*a1**2*c[0]*d1 + a1*a2*c[3]*d3 + 2*a1*a2*c[8]*d2 + 2*a1*a2*c[4]*d1 + 2*a1*a3*c[9]*d3 + a1*a3*c[3]*d2 + 2*a1*a3*c[5]*d1 + a1*c[14]*d3 + 
  a1*c[13]*d2 + 2*a1*c[10]*d1 + a2**2*c[6]*d3 + 3*a2**2*c[3]*d2 + a2**2*c[8]*d1 + 2*a2*a3*c[7]*d3 + 2*a2*a3*c[6]*d2 + a2*a3*c[3]*d1 + a2*c[15]*d3 + 2*a2*c[11]*d2 + 
  a2*c[13]*d1 + 3*a3**2*c[2]*d3 + a3**2*c[7]*d2 + a3**2*c[9]*d1 + 2*a3*c[12]*d3 + a3*c[15]*d2 + a3*c[14]*d1 + c[18]*d3 + c[17]*d2 + c[16]*d1;


  const c0 = a1**3*c[0] + a1**2*a2*c[4] + a1**2*a3*c[5] + a1**2*c[10] + a1*a2**2*c[8] + a1*a2*a3*c[3] + a1*a2*c[13] + 
  a1*a3**2*c[9] + a1*a3*c[14] + a1*c[16] + a2**3*c[1] + a2**2*a3*c[6] + a2**2*c[11] + a2*a3**2*c[7] + a2*a3*c[15] + a2*c[17] + 
  a3**3*c[2] + a3**2*c[12] + a3*c[18] + c[19];
