import"./modulepreload-polyfill-B5Qt9EMX.js";import{A as h,E as W,c as x,d as I,o as X,e as F,t as B,g as L,s as S,m as E,a as P,i as Y}from"./mat4-C5X1qZ4b.js";import{c as k,f as q,d as U,a as A,b as j,n as V,l as G}from"./vec3-D7uVn_o5.js";function K(){var r=new h(9);return h!=Float32Array&&(r[1]=0,r[2]=0,r[3]=0,r[5]=0,r[6]=0,r[7]=0),r[0]=1,r[4]=1,r[8]=1,r}function Q(){var r=new h(4);return h!=Float32Array&&(r[0]=0,r[1]=0,r[2]=0,r[3]=0),r}function Z(r,n){var t=n[0],e=n[1],c=n[2],o=n[3],a=t*t+e*e+c*c+o*o;return a>0&&(a=1/Math.sqrt(a)),r[0]=t*a,r[1]=e*a,r[2]=c*a,r[3]=o*a,r}(function(){var r=Q();return function(n,t,e,c,o,a){var i,s;for(t||(t=4),e||(e=0),c?s=Math.min(c*t+e,n.length):s=n.length,i=e;i<s;i+=t)r[0]=n[i],r[1]=n[i+1],r[2]=n[i+2],r[3]=n[i+3],o(r,r,a),n[i]=r[0],n[i+1]=r[1],n[i+2]=r[2],n[i+3]=r[3];return n}})();function w(){var r=new h(4);return h!=Float32Array&&(r[0]=0,r[1]=0,r[2]=0),r[3]=1,r}function D(r,n,t){t=t*.5;var e=Math.sin(t);return r[0]=e*n[0],r[1]=e*n[1],r[2]=e*n[2],r[3]=Math.cos(t),r}function J(r,n,t){var e=n[0],c=n[1],o=n[2],a=n[3],i=t[0],s=t[1],f=t[2],l=t[3];return r[0]=e*l+a*i+c*f-o*s,r[1]=c*l+a*s+o*i-e*f,r[2]=o*l+a*f+e*s-c*i,r[3]=a*l-e*i-c*s-o*f,r}function M(r,n,t,e){var c=n[0],o=n[1],a=n[2],i=n[3],s=t[0],f=t[1],l=t[2],y=t[3],u,d,p,z,m;return d=c*s+o*f+a*l+i*y,d<0&&(d=-d,s=-s,f=-f,l=-l,y=-y),1-d>W?(u=Math.acos(d),p=Math.sin(u),z=Math.sin((1-e)*u)/p,m=Math.sin(e*u)/p):(z=1-e,m=e),r[0]=z*c+m*s,r[1]=z*o+m*f,r[2]=z*a+m*l,r[3]=z*i+m*y,r}function rr(r,n){var t=n[0]+n[4]+n[8],e;if(t>0)e=Math.sqrt(t+1),r[3]=.5*e,e=.5/e,r[0]=(n[5]-n[7])*e,r[1]=(n[6]-n[2])*e,r[2]=(n[1]-n[3])*e;else{var c=0;n[4]>n[0]&&(c=1),n[8]>n[c*3+c]&&(c=2);var o=(c+1)%3,a=(c+2)%3;e=Math.sqrt(n[c*3+c]-n[o*3+o]-n[a*3+a]+1),r[c]=.5*e,e=.5/e,r[3]=(n[o*3+a]-n[a*3+o])*e,r[o]=(n[o*3+c]+n[c*3+o])*e,r[a]=(n[a*3+c]+n[c*3+a])*e}return r}var O=Z;(function(){var r=k(),n=q(1,0,0),t=q(0,1,0);return function(e,c,o){var a=U(c,o);return a<-.999999?(A(r,n,c),j(r)<1e-6&&A(r,t,c),V(r,r),D(e,r,Math.PI),e):a>.999999?(e[0]=0,e[1]=0,e[2]=0,e[3]=1,e):(A(r,c,o),e[0]=r[0],e[1]=r[1],e[2]=r[2],e[3]=1+a,O(e,e))}})();(function(){var r=w(),n=w();return function(t,e,c,o,a,i){return M(r,e,a,i),M(n,c,o,i),M(t,r,n,2*i*(1-i)),t}})();(function(){var r=K();return function(n,t,e,c){return r[0]=e[0],r[3]=e[1],r[6]=e[2],r[1]=c[0],r[4]=c[1],r[7]=c[2],r[2]=-t[0],r[5]=-t[1],r[8]=-t[2],O(n,rr(n,r))}})();function $(){var r=new h(2);return h!=Float32Array&&(r[0]=0,r[1]=0),r}function nr(r,n){var t=new h(2);return t[0]=r,t[1]=n,t}function er(r,n){return r[0]=n[0],r[1]=n[1],r}function tr(r,n,t){return r[0]=n,r[1]=t,r}(function(){var r=$();return function(n,t,e,c,o,a){var i,s;for(t||(t=2),e||(e=0),c?s=Math.min(c*t+e,n.length):s=n.length,i=e;i<s;i+=t)r[0]=n[i],r[1]=n[i+1],o(r,r,a),n[i]=r[0],n[i+1]=r[1];return n}})();const cr=document.getElementById("coeffContainer"),or=["x³","y³","z³","x²y","x²z","y²z","yz²","xy²","xz²","xyz","x²","y²","z²","xz","xy","yz","x","y","z","1"],g=[81,81,81,-189,-189,-189,-189,-189,-189,54,-9,-9,-9,126,126,126,-9,-9,-9,1],_=[];for(let r=0;r<20;r++){const n=document.createElement("div");n.className="coeff-group";const t=document.createElement("label");t.textContent=`${or[r]}: `;const e=document.createElement("input");e.type="number",e.value=g[r].toString(),e.step="0.1";const c=document.createElement("input");c.type="range",c.min=(g[r]-10).toString(),c.max=(g[r]+10).toString(),c.step="0.1",c.value=g[r].toString(),e.addEventListener("input",()=>{const o=parseFloat(e.value)||0;c.min=(o-5).toFixed(1),c.max=(o+5).toFixed(1),c.value=o.toString(),N()}),c.addEventListener("input",()=>{e.value=c.value,N()}),n.appendChild(t),n.appendChild(e),n.appendChild(c),cr.appendChild(n),_.push(e)}globalThis.getUserCoeffs=()=>_.map(r=>parseFloat(r.value)||0);globalThis.getUserCoeffs.inputs=_;function N(){var c,o;const r=_.map(a=>parseFloat(a.value)||0),n=(c=window.ctx)==null?void 0:c.gl,t=(o=window.ctx)==null?void 0:o.program,e=n==null?void 0:n.getUniformLocation(t,"uCoeffs");n&&t&&e&&(n.useProgram(t),n.uniform1fv(e,new Float32Array(r)),window.ctx&&window.drawScene&&window.drawScene(window.ctx))}const ar=`#version 300 es\r
...
`;function R(r){const n=window.innerWidth,t=window.innerHeight,e=16/9;let c=n,o=n/e;o>t&&(o=t,c=t*e),r.width=c*window.devicePixelRatio,r.height=o*window.devicePixelRatio,r.style.width=`${c}px`,r.style.height=`${o}px`,r.style.position="absolute",r.style.top="50%",r.style.left="50%",r.style.transform="translate(-50%, -50%)"}function T(r,n,t){const e=r.createShader(n);if(r.shaderSource(e,t),r.compileShader(e),!r.getShaderParameter(e,r.COMPILE_STATUS))throw new Error(r.getShaderInfoLog(e)||"Shader compile error");return e}function fr(r,n,t){const e=T(r,r.VERTEX_SHADER,n),c=T(r,r.FRAGMENT_SHADER,t),o=r.createProgram();if(r.attachShader(o,e),r.attachShader(o,c),r.linkProgram(o),!r.getProgramParameter(o,r.LINK_STATUS))throw new Error(r.getProgramInfoLog(o)||"Program link error");return o}const v=3;function sr(r,n){const t=new Float32Array([-3,-3,-3,v,-3,-3,-3,v,-3,v,v,-3,-3,-3,v,v,-3,v,-3,v,v,v,v,v]),e=new Uint16Array([0,2,1,1,2,3,4,5,6,6,5,7,0,5,4,0,1,5,2,6,7,2,7,3,7,1,3,7,5,1,0,6,2,0,4,6]),c=r.createVertexArray();r.bindVertexArray(c);const o=r.createBuffer();r.bindBuffer(r.ARRAY_BUFFER,o),r.bufferData(r.ARRAY_BUFFER,t,r.STATIC_DRAW);const a=r.getAttribLocation(n,"aPosition");r.enableVertexAttribArray(a),r.vertexAttribPointer(a,3,r.FLOAT,!1,0,0);const i=r.createBuffer();return r.bindBuffer(r.ELEMENT_ARRAY_BUFFER,i),r.bufferData(r.ELEMENT_ARRAY_BUFFER,e,r.STATIC_DRAW),{vao:c,iboSize:e.length}}function H(r,n){const t=r.canvas,e=t.clientWidth,c=t.clientHeight,o=(2*n[0]-e)/e,a=(c-2*n[1])/c,i=1-o*o-a*a,s=i>0?Math.sqrt(i):0;return q(o,a,s)}function lr(r,n){const t=k();if(A(t,r,n),G(t)<1e-5)return w();V(t,t);const e=Math.max(-1,Math.min(1,U(r,n))),c=Math.acos(e);return D(w(),t,c)}function C(r){const n=r.gl,t=r.program;n.uniformMatrix4fv(n.getUniformLocation(t,"uProjection"),!1,r.projection),n.uniformMatrix4fv(n.getUniformLocation(t,"uModelView"),!1,r.modelView);const e=Y(x(),r.modelView);n.uniformMatrix4fv(n.getUniformLocation(t,"uModelInverse"),!1,e),n.uniform1i(n.getUniformLocation(t,"uSurface"),r.curSurface),n.uniform1i(n.getUniformLocation(t,"uOrthographic"),r.viewMode===2?1:0),n.bindVertexArray(r.cube.vao),n.drawElements(n.TRIANGLES,r.cube.iboSize,n.UNSIGNED_SHORT,0)}function b(r){const n=r.gl;n.viewport(0,0,n.canvas.width,n.canvas.height),n.clear(n.COLOR_BUFFER_BIT|n.DEPTH_BUFFER_BIT);const t=n.canvas.width/n.canvas.height,e=10,c=100,o=30,a=t*o;let i=0,s=0,f=50;if(I(r.projection),I(r.modelView),r.viewMode===2)X(r.projection,-a/2,a/2,-30/2,o/2,e,c);else{const y=e*(-a/2-i)/f,u=e*(a/2-i)/f,d=e*(-30/2-s)/f,p=e*(o/2-s)/f;F(r.projection,y,u,d,p,e,c)}B(r.modelView,r.modelView,[-0,-0,-50]);const l=L(x(),r.qNow);if(S(l,l,[r.zoom*15,r.zoom*15,r.zoom*15]),E(r.modelView,r.modelView,l),C(r),r.viewMode===3){const u=L(x(),r.qNow);S(u,u,[r.zoom*15,r.zoom*15,r.zoom*15]),n.colorMask(!0,!1,!1,!0);const d=x(),p=x();F(d,e*(-a/2-1.5)/f,e*(a/2-1.5)/f,e*(-30/2-s)/f,e*(o/2-s)/f,e,c),B(p,p,[-1.5,-0,-50]),E(r.modelView,p,u),P(r.projection,d),C(r),n.clear(n.DEPTH_BUFFER_BIT),n.colorMask(!1,!0,!0,!0);const z=x(),m=x();F(z,e*(-a/2+1.5)/f,e*(a/2+1.5)/f,e*(-30/2-s)/f,e*(o/2-s)/f,e,c),B(m,m,[1.5,-0,-50]),E(r.modelView,m,u),P(r.projection,z),C(r),n.colorMask(!0,!0,!0,!0)}}window.addEventListener("load",async()=>{var s;const r=document.getElementById("glcanvas"),n=r.getContext("webgl2");R(r),n.viewport(0,0,r.width,r.height);const t=fr(n,ar,ir);n.useProgram(t);const e=n.getUniformLocation(t,"uCoeffs"),c=sr(n,t),o={gl:n,program:t,cube:c,projection:x(),modelView:x(),qNow:w(),mousePos:$(),mousePressed:!1,zoom:.5,viewMode:1,curSurface:1};window.ctx=o,n.clearColor(.5,.5,.5,1),n.enable(n.DEPTH_TEST),n.enable(n.CULL_FACE);const a=(s=window.getUserCoeffs)==null?void 0:s.call(window);(a==null?void 0:a.length)===20&&n.uniform1fv(e,new Float32Array(a)),r.addEventListener("mousedown",f=>{o.mousePressed=!0,tr(o.mousePos,f.clientX,f.clientY)}),r.addEventListener("mouseup",()=>o.mousePressed=!1),r.addEventListener("mousemove",f=>{if(!o.mousePressed)return;const l=nr(f.clientX,f.clientY),y=H(n,o.mousePos),u=H(n,l),d=lr(y,u);J(o.qNow,d,o.qNow),er(o.mousePos,l),b(o)}),r.addEventListener("wheel",f=>{f.preventDefault(),o.zoom*=f.deltaY>0?1/1.1:1.1,b(o)},{passive:!1}),document.getElementById("viewMode").addEventListener("change",f=>{o.viewMode=parseInt(f.target.value),b(o)}),document.getElementById("surfaceMode").addEventListener("change",f=>{o.curSurface=parseInt(f.target.value),b(o)});function i(){b(o),requestAnimationFrame(i)}window.addEventListener("resize",()=>{R(r),n.viewport(0,0,r.width,r.height)}),i()});
