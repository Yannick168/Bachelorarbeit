...
`;function T(r){const o=window.innerWidth,e=window.innerHeight,n=16/9;let f=o,t=o/n;t>e&&(t=e,f=e*n),r.width=f*window.devicePixelRatio,r.height=t*window.devicePixelRatio,r.style.width=`${f}px`,r.style.height=`${t}px`,r.style.position="absolute",r.style.top="50%",r.style.left="50%",r.style.transform="translate(-50%, -50%)"}function V(r,o,e){const n=r.createShader(o);if(r.shaderSource(n,e),r.compileShader(n),!r.getShaderParameter(n,r.COMPILE_STATUS))throw new Error(r.getShaderInfoLog(n)||"Shader compile error");return n}function dr(r,o,e){const n=V(r,r.VERTEX_SHADER,o),f=V(r,r.FRAGMENT_SHADER,e),t=r.createProgram();if(r.attachShader(t,n),r.attachShader(t,f),r.linkProgram(t),!r.getProgramParameter(t,r.LINK_STATUS))throw new Error(r.getProgramInfoLog(t)||"Program link error");return t}const y=3;function sr(r,o){const e=new Float32Array([-3,-3,-3,y,-3,-3,-3,y,-3,y,y,-3,-3,-3,y,y,-3,y,-3,y,y,y,y,y]),n=new Uint16Array([0,2,1,1,2,3,4,5,6,6,5,7,0,5,4,0,1,5,2,6,7,2,7,3,7,1,3,7,5,1,0,6,2,0,4,6]),f=r.createVertexArray();r.bindVertexArray(f);const t=r.createBuffer();r.bindBuffer(r.ARRAY_BUFFER,t),r.bufferData(r.ARRAY_BUFFER,e,r.STATIC_DRAW);const c=r.getAttribLocation(o,"aPosition");r.enableVertexAttribArray(c),r.vertexAttribPointer(c,3,r.FLOAT,!1,0,0);const a=r.createBuffer();return r.bindBuffer(r.ELEMENT_ARRAY_BUFFER,a),r.bufferData(r.ELEMENT_ARRAY_BUFFER,n,r.STATIC_DRAW),{vao:f,iboSize:n.length}}function X(r,o){const e=r.canvas,n=e.clientWidth,f=e.clientHeight,t=(2*o[0]-n)/n,c=(f-2*o[1])/f,a=1-t*t-c*c,s=a>0?Math.sqrt(a):0;return B(t,c,s)}function ir(r,o){const e=_();if(A(e,r,o),k(e)<1e-5)return h();N(e,e);const n=Math.max(-1,Math.min(1,D(r,o))),f=Math.acos(n);return O(h(),e,f)}function P(r){const o=r.gl,e=r.program;o.uniformMatrix4fv(o.getUniformLocation(e,"uProjection"),!1,r.projection),o.uniformMatrix4fv(o.getUniformLocation(e,"uModelView"),!1,r.modelView);const n=W(w(),r.modelView);o.uniformMatrix4fv(o.getUniformLocation(e,"uModelInverse"),!1,n),o.uniform1i(o.getUniformLocation(e,"uSurface"),r.curSurface),o.uniform1i(o.getUniformLocation(e,"uOrthographic"),r.viewMode===2?1:0),o.bindVertexArray(r.cube.vao),o.drawElements(o.TRIANGLES,r.cube.iboSize,o.UNSIGNED_SHORT,0)}function b(r){const o=r.gl;o.viewport(0,0,o.canvas.width,o.canvas.height),o.clear(o.COLOR_BUFFER_BIT|o.DEPTH_BUFFER_BIT);const e=o.canvas.width/o.canvas.height,n=10,f=100,t=30,c=e*t;let a=0,s=0,d=50;if(q(r.projection),q(r.modelView),r.viewMode===2)Q(r.projection,-c/2,c/2,-30/2,t/2,n,f);else{const x=n*(-c/2-a)/d,l=n*(c/2-a)/d,p=n*(-30/2-s)/d,z=n*(t/2-s)/d;E(r.projection,x,l,p,z,n,f)}S(r.modelView,r.modelView,[-0,-0,-50]);const i=R(w(),r.qNow);if(F(i,i,[r.zoom*15,r.zoom*15,r.zoom*15]),M(r.modelView,r.modelView,i),P(r),r.viewMode===3){const l=R(w(),r.qNow);F(l,l,[r.zoom*15,r.zoom*15,r.zoom*15]),o.colorMask(!0,!1,!1,!0);const p=w(),z=w();E(p,n*(-c/2-1.5)/d,n*(c/2-1.5)/d,n*(-30/2-s)/d,n*(t/2-s)/d,n,f),S(z,z,[-1.5,-0,-50]),M(r.modelView,z,l),I(r.projection,p),P(r),o.clear(o.DEPTH_BUFFER_BIT),o.colorMask(!1,!0,!0,!0);const v=w(),u=w();E(v,n*(-c/2+1.5)/d,n*(c/2+1.5)/d,n*(-30/2-s)/d,n*(t/2-s)/d,n,f),S(u,u,[1.5,-0,-50]),M(r.modelView,u,l),I(r.projection,v),P(r),o.colorMask(!0,!0,!0,!0)}}window.addEventListener("load",async()=>{var s;const r=document.getElementById("glcanvas"),o=r.getContext("webgl2");T(r),o.viewport(0,0,r.width,r.height);const e=dr(o,cr,ar);o.useProgram(e);const n=o.getUniformLocation(e,"uCoeffs"),f=sr(o,e),t={gl:o,program:e,cube:f,projection:w(),modelView:w(),qNow:h(),mousePos:Y(),mousePressed:!1,zoom:.5,viewMode:1,curSurface:1};window.ctx=t,o.clearColor(.5,.5,.5,1),o.enable(o.DEPTH_TEST),o.enable(o.CULL_FACE);const c=(s=window.getUserCoeffs)==null?void 0:s.call(window);(c==null?void 0:c.length)===20&&o.uniform1fv(n,new Float32Array(c)),r.addEventListener("mousedown",d=>{t.mousePressed=!0,er(t.mousePos,d.clientX,d.clientY)}),r.addEventListener("mouseup",()=>t.mousePressed=!1),r.addEventListener("mousemove",d=>{if(!t.mousePressed)return;const i=or(d.clientX,d.clientY),x=X(o,t.mousePos),l=X(o,i),p=ir(x,l);J(t.qNow,p,t.qNow),nr(t.mousePos,i),b(t)}),r.addEventListener("wheel",d=>{d.preventDefault(),t.zoom*=d.deltaY>0?1/1.1:1.1,b(t)},{passive:!1}),document.getElementById("viewMode").addEventListener("change",d=>{t.viewMode=parseInt(d.target.value),b(t)}),document.getElementById("surfaceMode").addEventListener("change",d=>{t.curSurface=parseInt(d.target.value),b(t)});function a(){b(t),requestAnimationFrame(a)}window.addEventListener("resize",()=>{T(r),o.viewport(0,0,r.width,r.height)}),a()});
